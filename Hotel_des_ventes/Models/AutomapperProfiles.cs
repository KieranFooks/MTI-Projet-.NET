    ...
    public class AutomapperProfiles : Profile
	{
		public AutomapperProfiles()
		{
			...
			CreateMap<Market, ItemOfferModel>()
				...
				.ForMember(d => d.Seller, opt => opt.MapFrom(src => src.IdSellerNavigation.Name));
			...
			CreateMap<ItemAveragePrice, SellItemViewModel>()
                .ForMember(d => d.Id, opt => opt.MapFrom(src => src.Id))
                .ForMember(d => d.Name, opt => opt.MapFrom(src => src.Name))
                .ForMember(d => d.AveragePrice, opt => opt.MapFrom(src => src.AveragePrice));
